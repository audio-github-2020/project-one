				...
				<div class="zoom">
					<#if (imageList?? && imageList?size>0)>
						...
						<div id="preview" class="spec-preview">
								<span class="jqzoom">
									<img jqimg="${imageList[0].url}" width="400" height="400" src="${imageList[0].url}" />
								</span>
						</div>
						<!--下方的缩略图-->
					...
					<div id="specification" class="summary-wrap clearfix">
						<#list specificationList as specList>
							<dl>
								...
								<#list specList.attributeValue as specValue>
									<dd>
										<a href="javascript:;" ng-click="selectSpec('${specList.attributeName}','${specValue}')" class="{{isSelectedSpec('${specList.attributeName}','${specValue}')}}">
											${specValue}
					...
					<div class="summary-wrap">
						...
						<div class="fl">
							<ul class="btn-choose unstyled">
								<li>
									<a href="javascript:void(0)" ng-click="addCart()" target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
								</li>
							</ul>
						</div>
					</div>
